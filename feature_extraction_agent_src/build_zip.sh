...
# Builds a self-contained deployment.zip for the feature extraction agent
# targeting AWS Bedrock AgentCore (ARM64/Graviton).
...
cp "$SCRIPT_DIR/feature_extraction_agent.py" "$BUILD_DIR/"
